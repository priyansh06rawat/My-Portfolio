  ...
  const projects = [
    {
      ...
      liveUrl: "https://glassy-ui-blond.vercel.app/",
      githubUrl: "https://github.com/priyansh06rawat/Glassy_UI",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/priyansh06rawat/Weather-App",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-12 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          <Button 
            ...
            onClick={() => window.open('https://github.com/priyansh06rawat?tab=repositories', '_blank', 'noopener,noreferrer')}
          >
            View All Projects
